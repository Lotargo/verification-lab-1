...
Each subdirectory contains a standalone reproducibility pack with executable code, results, figures, dependency specifications, and a browsable experimental report.
...
- **Report**: [EXP001_gravity_verification.md](./EXP-001/EXP-001-reproducibility-pack/exp_docs/EXP001_gravity_verification.md)
- **Reproducibility Pack**: [EXP-001-reproducibility-pack.zip](./EXP-001/EXP-001-reproducibility-pack.zip)
...
- **Report**: [EXP002_adversarial_verification.md](./EXP-002/EXP-002-reproducibility-pack/exp_docs/EXP002_adversarial_verification.md)
- **Reproducibility Pack**: [EXP-002-reproducibility-pack.zip](./EXP-002/EXP-002-reproducibility-pack.zip)
...
- **Report**: [EXP003_singularity_semantics.md](./EXP-003/EXP-003-reproducibility-pack/exp_docs/EXP003_singularity_semantics.md)
- **Reproducibility Pack**: [EXP-003-reproducibility-pack.zip](./EXP-003/EXP-003-reproducibility-pack.zip)
...
- **Report**: [EXP004_sat_challenge.md](./EXP-004/EXP-004-alpha-reproducibility-pack/exp_docs/EXP004_sat_challenge.md)
- **Reproducibility Pack**: [EXP-004-alpha-reproducibility-pack.zip](./EXP-004/EXP-004-alpha-reproducibility-pack.zip)
